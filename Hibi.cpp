/* ------------------------------------------------------------
name: "Hibi"
Code generated with Faust 2.78.5 (https://faust.grame.fr)
...
struct mydsp : public dsp {
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst9 = 4.656613e-10f / fConst1;
		fConst10 = 1.0f / (fConst4 + 1.0f);
		fConst11 = std::max<float>(1.0f, 0.001f * fConst0);
		fConst12 = 1.0f / fConst11;
		fConst13 = 1.0f / std::max<float>(1.0f, 0.05f * fConst0);
		fConst14 = 1.0f / (fConst2 * fConst6);
		fConst15 = std::tan(9424.778f / fConst0);
		fConst16 = mydsp_faustpower2_f(fConst15);
		fConst17 = 2.0f * (1.0f - 1.0f / fConst16);
		fConst18 = 1.0f / fConst15;
		fConst19 = (fConst18 + -1.0f) / fConst15 + 1.0f;
		fConst20 = 1.0f / ((fConst18 + 1.0f) / fConst15 + 1.0f);
		fConst21 = 1.0f - fConst18;
		fConst22 = 4.656613e-10f / fConst15;
		fConst23 = 1.0f / (fConst18 + 1.0f);
		fConst24 = 0.001f / fConst16;
		fConst25 = 1e+02f / fConst0;
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Hibi");
		ui_interface->addNumEntry("freq", &fEntry3, FAUSTFLOAT(4.4e+02f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(2e+04f), FAUSTFLOAT(0.01f));
		ui_interface->addNumEntry("gate1", &fEntry4, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("gate2", &fEntry2, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("gate3", &fEntry1, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("gate4", &fEntry0, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow3 = fConst26 * float(fEntry3);
		float fSlow4 = fConst30 * float(fEntry4);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			iVec0[0] = 1;
			iRec2[0] = 1103515245 * iRec2[1] + 12345;
			float fTemp0 = float(iRec2[0]);
			fVec1[0] = fTemp0;
			float fTemp1 = fTemp0 - fVec1[1];
			fRec1[0] = fConst10 * (fConst9 * fTemp1 - fConst8 * fRec1[1]);
			fRec0[0] = fRec1[0] - fConst7 * (fConst5 * fRec0[2] + fConst3 * fRec0[1]);
			fVec2[0] = fSlow0;
			iRec3[0] = (iRec3[1] + (iRec3[1] > 0)) * (fSlow0 <= fVec2[1]) + (fSlow0 > fVec2[1]);
			float fTemp2 = float(iRec3[0]);
			fRec5[0] = fConst23 * (fConst22 * fTemp1 - fConst21 * fRec5[1]);
			fRec4[0] = fRec5[0] - fConst20 * (fConst19 * fRec4[2] + fConst17 * fRec4[1]);
			fRec7[0] = fConst23 * (4.656613e-10f * (fTemp0 + fVec1[1]) - fConst21 * fRec7[1]);
			fRec6[0] = fRec7[0] - fConst20 * (fConst19 * fRec6[2] + fConst17 * fRec6[1]);
			fVec3[0] = fSlow1;
			iRec8[0] = (iRec8[1] + (iRec8[1] > 0)) * (fSlow1 <= fVec3[1]) + (fSlow1 > fVec3[1]);
			float fTemp3 = float(iRec8[0]);
			int iTemp4 = 1 - iVec0[1];
			float fTemp5 = ((iTemp4) ? 0.0f : fConst25 + fRec10[1]);
			fRec10[0] = fTemp5 - std::floor(fTemp5);
			fVec5[0] = fSlow2;
			iRec11[0] = (iRec11[1] + (iRec11[1] > 0)) * (fSlow2 <= fVec5[1]) + (fSlow2 > fVec5[1]);
			float fTemp6 = float(iRec11[0]);
			fRec12[0] = fSlow3 + fConst27 * fRec12[1];
			float fTemp7 = std::max<float>(fRec12[0], 23.44895f);
			float fTemp8 = std::max<float>(2e+01f, std::fabs(fTemp7));
			float fTemp9 = ((iTemp4) ? 0.0f : fRec13[1] + fConst28 * fTemp8);
			fRec13[0] = fTemp9 - std::floor(fTemp9);
			float fTemp10 = mydsp_faustpower2_f(2.0f * fRec13[0] + -1.0f);
			fVec6[0] = fTemp10;
			float fTemp11 = float(iVec0[1]) * (fTemp10 - fVec6[1]) / fTemp8;
			fVec7[IOTA0 & 4095] = fTemp11;
			float fTemp12 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst29 / fTemp7));
			int iTemp13 = int(fTemp12);
			float fTemp14 = std::floor(fTemp12);
			output0[i0] = FAUSTFLOAT(fSlow4 * (fTemp11 - fVec7[(IOTA0 - iTemp13) & 4095] * (fTemp14 + (1.0f - fTemp12)) - (fTemp12 - fTemp14) * fVec7[(IOTA0 - (iTemp13 + 1)) & 4095]) + std::max<float>(0.0f, std::min<float>(fConst12 * fTemp6, fConst13 * (fConst11 - fTemp6) + 1.0f)) * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(int(65536.0f * fRec10[0]), 65535))] + fConst20 * std::max<float>(0.0f, std::min<float>(fConst12 * fTemp3, fConst13 * (fConst11 - fTemp3) + 1.0f)) * (fRec6[2] + fRec6[0] + 2.0f * fRec6[1] + fConst24 * (fRec4[2] + (fRec4[0] - 2.0f * fRec4[1]))) + fConst14 * std::max<float>(0.0f, std::min<float>(fConst12 * fTemp2, fConst13 * (fConst11 - fTemp2) + 1.0f)) * (fRec0[2] + (fRec0[0] - 2.0f * fRec0[1])));
			iVec0[1] = iVec0[0];
			iRec2[1] = iRec2[0];
			fVec1[1] = fVec1[0];
			fRec1[1] = fRec1[0];
	...
	#define FAUST_FILE_NAME "Hibi.dsp"
	...
	FAUST_ADDNUMENTRY("freq", fEntry3, 4.4e+02f, 2e+01f, 2e+04f, 0.01f);
	FAUST_ADDNUMENTRY("gate1", fEntry4, 0.0f, 0.0f, 1.0f, 1.0f);
	FAUST_ADDNUMENTRY("gate2", fEntry2, 0.0f, 0.0f, 1.0f, 1.0f);
	FAUST_ADDNUMENTRY("gate3", fEntry1, 0.0f, 0.0f, 1.0f, 1.0f);
	FAUST_ADDNUMENTRY("gate4", fEntry0, 0.0f, 0.0f, 1.0f, 1.0f);

	#define FAUST_LIST_ACTIVES(p) \
		p(NUMENTRY, freq, "freq", fEntry3, 4.4e+02f, 2e+01f, 2e+04f, 0.01f) \
		p(NUMENTRY, gate1, "gate1", fEntry4, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(NUMENTRY, gate2, "gate2", fEntry2, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(NUMENTRY, gate3, "gate3", fEntry1, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(NUMENTRY, gate4, "gate4", fEntry0, 0.0f, 0.0f, 1.0f, 1.0f) \
...
Hibi::Hibi() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void Hibi::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void Hibi::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float Hibi::getParamValue(const std::string& path)
{
